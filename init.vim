...
nnoremap <leader>p <Cmd>call VSCodeNotify('copyRelativeFilePath')<CR>
...
nnoremap <leader>b <cmd>call VSCodeNotify('workbench.action.showAllEditorsByMostRecentlyUsed')<cr>
nnoremap <leader><leader> <cmd>call VSCodeNotify('workbench.action.quickOpenPreviousRecentlyUsedEditor')<cr>
