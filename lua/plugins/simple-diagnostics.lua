...
local severity = {
  ...
  { texthl = "DiagnosticSignError", sign = "DiagnosticSignError" },
  { texthl = "DiagnosticSignWarn", sign = "DiagnosticSignWarning" },
  { texthl = "DiagnosticSignInfo", sign = "DiagnosticSignInfo" },
  { texthl = "DiagnosticSignHint", sign = "DiagnosticSignHint" },
}
...
vim.api.nvim_create_autocmd({ 'CursorHold', 'InsertLeave' }, {
  pattern = '*.*',
  group = augroup,
  callback = function() printDiagnostics(
